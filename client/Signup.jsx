      ...
      <div className="content">
        ...
        <form className="form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="text" id="firstnameSignup" onChange={(e) => setFirstname(e.target.value)} value={first_name} />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type="text" onChange={(e) => setPhoneNumber(e.target.value)} value={phone_number} />
          </div>
